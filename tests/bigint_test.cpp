...
BOOST_AUTO_TEST_CASE( int160_test )
{
  ...
  std::vector< uint8_t > expected = { 0x00, 0x00, 0x00, 0x01, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
BOOST_AUTO_TEST_CASE( int256_test )
{
  ...
  std::vector< uint8_t > expected = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
